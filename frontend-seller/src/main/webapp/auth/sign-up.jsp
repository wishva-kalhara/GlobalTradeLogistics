...
<head>
    ...
    <title>Create account &mdash; Seller Portal</title>
...
<main class="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-md">
        <div class="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            ...
            <p class="mb-6 text-sm text-gray-500">Already have an account? <a href="/seller/auth/login.jsp" class="font-medium text-green-700 hover:underline">Log in</a></p>
            ...
            <form id="sign-up-form" class="space-y-4">
                ...
                <p class="text-xs text-gray-500">You'll fill in your business name, mobile, and address after you sign in for the first time.</p>
...
<script>
    ...
    document.getElementById("sign-up-form").addEventListener("submit", async function (e) {
        ...
        try {
            const res = await fetch("/api/v1/auth/signup/supplier", {
                method: "POST",
