...
<head>
    ...
    <title>Log in &mdash; Staff Console</title>
...
<main class="mx-auto max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
    <div class="mx-auto max-w-md">
        <div class="rounded-2xl border border-gray-200 bg-white p-8 shadow-sm">
            <h1 class="mb-1 text-xl font-semibold text-gray-900">Staff sign-in</h1>
            <p class="mb-6 text-sm text-gray-500">Passwordless sign-in with a one-time email code. Accounts are provisioned by an administrator.</p>
