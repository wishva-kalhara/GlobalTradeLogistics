<nav class="border-b border-gray-200 bg-white">
    <div class="mx-auto flex h-16 max-w-5xl items-center justify-between px-4 sm:px-6 lg:px-8">
        <a href="/app/index.jsp" class="flex items-center gap-2">
            ...
            <span class="text-lg font-semibold text-gray-900">GlobalTrade Logistics &mdash; Staff Console</span>
        </a>
    ...
    (function () {
        ...
        const ROLE_FUNCTIONS = {
            ADMIN: [
                ...
                { href: "/app/shipments/list.jsp", label: "Shipments" },
            ],
            COORDINATOR: [
            ...
            CUSTOMS_AGENT: [
                ...
                { href: "/app/shipments/list.jsp", label: "All Shipments" },
            ],
        };
